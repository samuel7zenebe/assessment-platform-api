...
export const getAuditLogs = factory.createHandlers(sValidator("query", AuditLogsQuerySchema), async (c) => {
    const { entityName, entityId, userId, startDate, endDate, limit, offset, } = c.req.valid("query");
