...
import { attemptQuestionAnswerRouter } from "./routes/attempt-question-answer/index.js";
...
AppRouter.route("/attempt-questions", attemptQuestionAnswerRouter);
...
AppRouter.post("/question-exists", sValidator("json", z.object({
    jobId: z.uuid(),
...
AppRouter.post("/distribution", sValidator("json", CreateExamSchema), async (c) => {
