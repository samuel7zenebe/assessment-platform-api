import { pgTable, text, varchar, integer, boolean, timestamp, decimal, uuid, pgEnum, primaryKey, unique, index, jsonb, } from "drizzle-orm/pg-core";
...
export const questionBank = pgTable("question_bank", {
    ...
    */
    questionData: jsonb("question_data").$type(),
    /*
...
/* =========================================================
   QUESTION JOB TITLES
========================================================= */
export const questionJobTitles = pgTable("question_job_titles", {
    questionId: uuid("question_id")
        .notNull()
        .references(() => questionBank.id, {
        onDelete: "cascade",
...
EXAM JOBTITLES
=========================================================*/
export const examJobTitles = pgTable("exam_job_titles", {
    id: uuid("id").defaultRandom().primaryKey(),
    examId: uuid("exam_id")
        .notNull()
        .references(() => exams.id, {
...
export const examAttempts = pgTable("exam_attempts", {
    ...
    unique("unique_exam_attempt").on(table.examId, table.candidateId, table.attemptNumber),
]);
/* =========================================================
   ATTEMPT Questions
========================================================= */
...
export const answers = pgTable("answers", {
    ...
    */
    selectedChoiceId: uuid("selected_choice_id").references(() => questionChoices.id, {
        onDelete: "set null",
    }),
    /*
      Essay / text answers
