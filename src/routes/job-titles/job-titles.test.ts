...
mock.module("./jobTitlesRepo.js", () => ({
  jobTitlesRepo: {
    ...
    createJobTitle: mock((titleName: string) => Promise.resolve([])),
    updateJobTitle: mock((id: string, data: any) => Promise.resolve([])),
    deleteJobTitle: mock((id: string) => Promise.resolve([])),
  },
}));
